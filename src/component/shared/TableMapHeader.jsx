      ...
      <div className="flex items-center gap-3 mt-2 sm:mt-0">
        ...
        {import.meta.env.DEV && (
          <button
            ...
            className="flex items-center gap-1.5 bg-linear-to-r from-purple-500 to-indigo-650 hover:from-purple-600 hover:to-indigo-750 text-white text-xs font-bold px-3.5 py-2.5 rounded-xl transition-all shadow-sm hover:-translate-y-0.5 active:scale-95 cursor-pointer"
