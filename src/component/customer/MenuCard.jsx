      ...
      <div className="p-3 md:p-5 pt-0 mt-auto flex justify-between items-end gap-1">
        ...
        {isSoldOut ? (
          ...
          <button
            ...
            className="bg-transparent border-2 border-[#e4002b] text-[#e4002b] px-2 py-1.5 md:px-3 md:py-2 rounded-md font-bold transition-all hover:bg-[#e4002b] hover:text-white hover:scale-105 flex items-center gap-1 text-[10px] md:text-sm cursor-pointer"
          >
