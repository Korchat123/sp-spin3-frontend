...
export default function SettingsMockup() {
  return (
    <div className="p-6 md:p-10 font-['IBM_Plex_Sans_Thai'] min-h-screen bg-gray-50 flex flex-col gap-6 animate-in fade-in duration-300">
      {/* Header */}
      <div className="flex flex-col gap-2">
        <h1 className="font-['Bebas_Neue'] text-4xl text-[#242424] tracking-widest flex items-center gap-3">
          <Settings size={36} className="text-[#e4002b]" />
          SYSTEM SETTINGS
        </h1>
        <p className="text-gray-500 font-medium text-sm">
          จัดการระบบหลังบ้านและตั้งค่าร้านค้า (Store Configuration)
        </p>
      </div>

      {/* Banner แจ้งเตือนว่ากำลังพัฒนา */}
      <div className="bg-[#242424] text-white p-4 rounded-xl border-l-8 border-[#e4002b] shadow-[4px_4px_0_#e4002b] flex items-start gap-4 mt-2">
        <Construction
          size={28}
        ...
        <div>
          ...
          <p className="text-sm text-gray-300 mt-1">
            หน้าต่างการตั้งค่าระดับผู้จัดการร้าน (Manager)
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 max-w-4xl">
        ...
        <div className="relative bg-white border-2 border-gray-200 rounded-2xl p-6 opacity-80 grayscale-20 select-none overflow-hidden group">
          ...
          <p className="text-sm text-gray-500 leading-relaxed">
            ...
            <span className="text-[#e4002b] text-xs font-bold mt-1 inline-block">
              *หากปิดระบบ ลูกค้าฝั่งหน้าเว็บจะไม่สามารถสั่งเดลิเวอรีได้
            </span>
          </p>
        ...
        <div className="relative bg-white border-2 border-gray-200 rounded-2xl p-6 opacity-80 grayscale-20 select-none overflow-hidden">
          ...
          <p className="text-sm text-gray-500 leading-relaxed">
            สร้างและจัดการโค้ดส่วนลด (Discount Codes) ตั้งค่าเงื่อนไขการใช้งาน
            และแคมเปญโปรโมชั่นต่างๆ เพื่อกระตุ้นยอดขาย
          </p>
